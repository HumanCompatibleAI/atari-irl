...
for i in 1 2 4 8 16 64; do
    echo $i;
    base_command="python train_airl.py --env $ENV --seed $SEED --trajectories_file results/$BASE_DIR/8_trajectories_cache.pkl --n_iter 1 --discriminator_itrs 1000 --policy_update_freq 1 --ppo_itrs_in_batch $i --init_location results/$BASE_DIR/expert.pkl --ablation train_discriminator";
